...
plt.plot(X_train[:241,0], output[:241,5].detach().numpy(), 'o', markersize=1, label='PINN 6W')
plt.plot(X_train[723:1084,0], output[723:1084,5].detach().numpy(), 'o', markersize=1, label='PINN 5W')
plt.plot(X_train[1806:2406,0], output[1806:2406,5].detach().numpy(), 'o', markersize=1, label='PINN 4W')
plt.xlabel('Time [sec]')
...
print(f'dHrx: {float(model.dHrx.detach().numpy())}')