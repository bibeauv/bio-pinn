...
class Curiosity():
    ...
    def __init__(self, X, Y, idx, f_hat, device, prm):
        ...
        self.PINN = PINeuralNet(device).to(device)
    ...
    def loss(self, x, y_train):
        ...
        self.loss_T_ode = self.loss_function_ode(self.prm.m_Cp*grad_T - self.PINN.e*self.prm.Q - self.prm.dHrx * grad_cA * self.prm.V - self.PINN.c1*T - self.PINN.c2, self.f_hat)
