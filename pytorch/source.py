...
class cTGNN():
    ...
    def __init__(self, device, f_hat, c_pred, k_pred, t_train, cTG_train, idx):
        ...
        self.dnn.register_parameter('k1', self.dnn.k1)
        self.dnn.register_parameter('k2', self.dnn.k2)
        self.dnn.register_parameter('k3', self.dnn.k3)
        self.dnn.register_parameter('k4', self.dnn.k4)
        self.dnn.register_parameter('k5', self.dnn.k5)
        self.dnn.register_parameter('k6', self.dnn.k6)
    ...
    def loss(self, x, y):
        ...
        loss_cTG_ode = self.loss_function_ode(grad_cTG + self.dnn.k1*self.cTG - self.dnn.k2*self.cDG*self.cB, self.f_hat)
...
class cDGNN():
    ...
    def loss(self, x, y):
        ...
        loss_cDG_ode = self.loss_function_ode(grad_cDG - self.dnn.k1*self.cTG + self.dnn.k2*self.cDG*self.cB \
                                                       + self.dnn.k3*self.cDG - self.dnn.k4*self.cMG*self.cB, self.f_hat)
        
        loss_cDG_data = self.loss_function_data(self.cDG, y)
...
class cMGNN():
    ...
    def loss(self, x, y):
        ...
        loss_cMG_ode = self.loss_function_ode(grad_cMG - self.dnn.k3*self.cDG + self.dnn.k4*self.cMG*self.cB \
                                                       + self.dnn.k5*self.cMG - self.dnn.k6*self.cG*self.cB, self.f_hat)
        
        loss_cMG_data = self.loss_function_data(self.cMG, y)
...
class cBNN():
    ...
    def __init__(self, device, f_hat, c_pred, k_pred, t_train, cB_train, idx=0):
    ...
    def loss(self, x):
        ...
        loss_cB_ode = self.loss_function_ode(grad_cB - self.dnn.k1*self.cTG + self.dnn.k2*self.cDG*self.cB \
...
class cGNN():
    ...
    def __init__(self, device, f_hat, c_pred, k_pred, t_train, cG_train, idx=0):
